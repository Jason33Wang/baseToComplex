...
UNIT = 40   # pixels
MAZE_H = 27  # grid height
MAZE_W = 27  # grid width
...
class Maze(tk.Tk, object):
    ...
    def step(self, action):
        ...
        # reward function
        reward,done = self.reward(next_coords=next_coords,oval_coords=self.canvas.coords(self.oval))
    ...
    def render(self):
        time.sleep(0.1)
        self.update()
    def reward(self,next_coords,oval_coords):
